...
Postprocessdir = 'C:\Users\ellab.GENECTR\Desktop\current_subjects\BECKYS_DATA\MERGED_FEMALES\RECALL\processed_denoise60hz_filt20to55\';
...
%     try
    ...
    switch nCSCs
        case 2
            names={'CeA_L','BNST_L'};
        case 4
            names={'CeA_L','BNST_L','BNST_R', 'CeA_R'};
        case 5 
           names={'CeA_L','BNST_L','BNST_R', 'LIES', 'CeA_R'};
  ...
  for b=1:length(names)
        for c=1:length(LFPs.CSts)
            ...
            ind(1);
            ind(length(ind));
            [LFPs.Filt.(names{b}).CS{c},foo,LFPs.Pwr.(names{b}).CS{c},LFPs.Phase.(names{b}).CS{c}]=SinoFilt_Joe((LFPs.dn60preRMS.(names{b})(ind(1):ind(length(ind)))),2000,8,20,55);
            end
        end   
     ...
     for b=1:length(names)
        for c=1:length(LFPs.pCSts)
            ...
            ind(1);
            ind(length(ind));
            [LFPs.Filt.(names{b}).pCS{c},foo,LFPs.Pwr.(names{b}).pCS{c},LFPs.Phase.(names{b}).pCS{c}]=SinoFilt_Joe((LFPs.dn60preRMS.(names{b})(ind(1):ind(length(ind)))),2000,8,20,55);
              end
    end 
...
%prepips_bins=flipud(prepips_bins); %no longer need this but it's a cool
%command to keep in mind (invert row order)
...
TPHNEG_CeA_L={'TPH645_RECALL','TPH646_RECALL','TPH647_RECALL','TPH891_RECALL','TPH1006_RECALL','TPH1406_RECALL'};
...
plot(mean(uuuu.prepip1,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip2,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip3,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip4,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip5,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip6,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip7,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip8,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip9,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip10,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip11,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip12,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip13,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip14,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip15,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip16,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip17,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip18,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip19,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip20,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip21,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip22,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip23,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip24,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip25,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip26,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip27,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip28,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip29,2)); hold on; xlim([20 50])
plot(mean(uuuu.prepip30,2)); hold on; xlim([20 50])
        end
         xlabel('Freq (Hz)')
...
plot(mean(uuuu.pip1,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip2,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip3,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip4,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip5,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip6,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip7,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip8,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip9,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip10,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip11,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip12,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip13,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip14,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip15,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip16,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip17,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip18,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip19,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip20,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip21,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip22,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip23,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip24,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip25,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip26,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip27,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip28,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip29,2)); hold on; xlim([20 50])
plot(mean(uuuu.pip30,2)); hold on; xlim([20 50])
        end
         xlabel('Freq (Hz)')
...
Freq=Freq_pw;
gamma_freq_idx_30_50=find(Freq>=30 & Freq<=50);
...
%tph- ACSF
 subplot(3,4,1)     
        ...
        xlim([20 50]); ylim([1 800000]) ;title([char(names(n)), ' RECALL TPH-' ]); 
...
%TPH+ ACSF
     subplot(3,4,2)     
        ...
        %CeA L
        subplot(3,4,3)
        CS_SEM = std(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH- all CSs ', ' ','TPH- all pCSs'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
        
        subplot(3,4,7)
        CS_SEM = std(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
         ylim([0 500000]);legend('TPH- CS1-4 ', ' ','TPH- all pCSs'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
        
        subplot(3,4,11)
        CS_SEM = std(mean(fooTPHNEG{4,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{4,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHNEG{4,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHNEG{4,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH- CS7-10 ', ' ','TPH- all pCSs'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
       ...
       fooTPHPOS=struct2cell(Pwr_all.(names{n}).TPHPOS);
        %CeA L
        subplot(3,4,4)
        CS_SEM = std(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH+ all CSs ', ' ','TPH+ all pCSs'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
        
        subplot(3,4,8)
        CS_SEM = std(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
         ylim([0 500000]);legend('TPH+ CS1-4 ', ' ','TPH+ all pCSs'); 
        ...
        subplot(3,4,12)
        CS_SEM = std(mean(fooTPHPOS{4,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{4,1}(gamma_freq_idx_30_50,:)))-1);
        bar(3,(mean(mean(fooTPHPOS{4,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5469 0')
        hold on; errorbar(3,mean(mean(fooTPHPOS{4,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on; CS_SEM = std(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))-1);         
        bar(4,(mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH+ CS7-10 ', ' ','TPH+ all pCSs'); 
...
n=1 ;%CeA_L
        ...
        hold on
        xlim([20 50]);ylim([0.5 1.5]); title([char(names(n)), ' RECALL ']); ylabel('NORM Power')
...
subplot(3,4,2)
        fooTPHNEG=struct2cell(Pwr_all.(names{n}).TPHNEG);
        CS_SEM = std(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on; errorbar(1,mean(mean(fooTPHNEG{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')  

        fooTPHPOS=struct2cell(Pwr_all.(names{n}).TPHPOS);
        CS_SEM = std(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on; errorbar(2,mean(mean(fooTPHPOS{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        ylim([0 1.5]);legend('TPH- all CS ',' ','TPH+ all CS ', ' '); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
      
        subplot(3,4,6)
        fooTPHNEG=struct2cell(Pwr_all.(names{n}).TPHNEG);
        CS_SEM = std(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on; errorbar(1,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
  
        fooTPHPOS=struct2cell(Pwr_all.(names{n}).TPHPOS);
        CS_SEM = std(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on; errorbar(2,mean(mean(fooTPHPOS{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        ...
        fooTPHNEG=struct2cell(Pwr_all.(names{n}).TPHNEG);
        CS_SEM = std(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on; errorbar(1,mean(mean(fooTPHNEG{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        

        fooTPHPOS=struct2cell(Pwr_all.(names{n}).TPHPOS);
        CS_SEM = std(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on; errorbar(2,mean(mean(fooTPHPOS{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
...
%cea
forcutoff1=struct('TPH645_RECALL',[],'TPH646_RECALL',[],'TPH647_RECALL',[],'TPH891_RECALL',[],'TPH1006_RECALL',[],'TPH1406_RECALL',[]);
...
for a=1:length(TPHNEG_CeA_L)
        for b=1%1:length(names)
         forcutoff1.(TPHNEG_CeA_L{a}).(names{b})=cat(2,LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS1.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS2.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS3.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS4.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS5.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS6.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS7.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS8.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS9.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHNEG_CeA_L)
 ...
 for a=1:length(TPHNEG_CeA_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.(CSname{c}).(Pipname{d})(32:52,:),2))>(cutoff3.(TPHNEG_CeA_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
forcutoff1_pre=struct('TPH645_RECALL',[],'TPH646_RECALL',[],'TPH647_RECALL',[],'TPH891_RECALL',[],'TPH1006_RECALL',[],'TPH1406_RECALL',[]);
...
for a=1:length(TPHNEG_CeA_L)
        for b=1%1:length(names)
         forcutoff1_pre.(TPHNEG_CeA_L{a}).(names{b})=cat(2,LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS1.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS2.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS3.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS4.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS5.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS6.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS7.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS8.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS9.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHNEG_CeA_L)
 ...
 for a=1:length(TPHNEG_CeA_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHNEG.(TPHNEG_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.(pCSname{c}).(Prepipname{d})(32:52,:),2))>(cutoff3_pre.(TPHNEG_CeA_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHPOS_CeA_L)
        for b=1%1:length(names)
         forcutoff1.(TPHPOS_CeA_L{a}).(names{b})=cat(2,LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS1.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS2.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS3.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS4.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS5.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS6.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS7.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS8.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS9.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHPOS_CeA_L)
 ...
 for a=1:length(TPHPOS_CeA_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.(CSname{c}).(Pipname{d})(32:52,:),2))>(cutoff3.(TPHPOS_CeA_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHPOS_CeA_L)
        for b=1%1:length(names)
         forcutoff1_pre.(TPHPOS_CeA_L{a}).(names{b})=cat(2,LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS1.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS2.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS3.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS4.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS5.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS6.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS7.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS8.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS9.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHPOS_CeA_L)
 ...
 for a=1:length(TPHPOS_CeA_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHPOS.(TPHPOS_CeA_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.(pCSname{c}).(Prepipname{d})(32:52,:),2))>(cutoff3_pre.(TPHPOS_CeA_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHNEG_BNST_L)
        for b=2%1:length(names)
         forcutoff1.(TPHNEG_BNST_L{a}).(names{b})=cat(2,LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS1.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS2.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS3.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS4.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS5.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS6.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS7.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS8.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS9.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHNEG_BNST_L)
 ...
 for a=1:length(TPHNEG_BNST_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.(CSname{c}).(Pipname{d})(32:52,:),2))>(cutoff3.(TPHNEG_BNST_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHNEG_BNST_L)
        for b=2%1:length(names)
         forcutoff1_pre.(TPHNEG_BNST_L{a}).(names{b})=cat(2,LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS1.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS2.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS3.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS4.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS5.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS6.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS7.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS8.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS9.meaneachpip_altogether(32:52,:),LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHNEG_BNST_L)
 ...
 for a=1:length(TPHNEG_BNST_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHNEG.(TPHNEG_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.(pCSname{c}).(Prepipname{d})(32:52,:),2))>(cutoff3_pre.(TPHNEG_BNST_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHPOS_BNST_L)
        for b=2%1:length(names)
         forcutoff1.(TPHPOS_BNST_L{a}).(names{b})=cat(2,LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS1.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS2.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS3.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS4.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS5.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS6.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS7.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS8.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS9.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.CS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHPOS_BNST_L)
 ...
 for a=1:length(TPHPOS_BNST_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Pips_freqtime.(CSname{c}).(Pipname{d})(32:52,:),2))>(cutoff3.(TPHPOS_BNST_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
for a=1:length(TPHPOS_BNST_L)
        for b=2%1:length(names)
         forcutoff1_pre.(TPHPOS_BNST_L{a}).(names{b})=cat(2,LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS1.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS2.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS3.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS4.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS5.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS6.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS7.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS8.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS9.meaneachpip_altogether(32:52,:),LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.pCS10.meaneachpip_altogether(32:52,:))
    end
end
...
for a=1:length(TPHPOS_BNST_L)
 ...
 for a=1:length(TPHPOS_BNST_L)
 	...
 	xx_ind1=mean(mean(LFPsall.TPHPOS.(TPHPOS_BNST_L{a}).TonePwr.(names{b}).pips.Prepips_freqtime.(pCSname{c}).(Prepipname{d})(32:52,:),2))>(cutoff3_pre.(TPHPOS_BNST_L{a}).(names{b}));
    find(xx_ind1==1)
    if find(xx_ind1==1) ~= 0
...
%%
TPHNEG_BNST_L={'TPH645_RECALL','TPH647_RECALL','TPH662_RECALL','TPH891_RECALL','TPH1006_RECALL','TPH1025_RECALL','TPH1398_RECALL','TPH1406_RECALL'};
TPHPOS_BNST_L={'TPH394_RECALL','TPH655_RECALL','TPH905_RECALL','TPH907_RECALL','TPH1008_RECALL','TPH1026_RECALL','TPH1389_RECALL','TPH1390_RECALL','TPH1397_RECALL'};
...
n=1 % cea
 ...
 subplot(3,4,1)     
        ...
        xlim([20 50]); ylim([0 800000]) ;title([char(names(n)), ' RECALL TPH-' ]); 
...
n=2 % BNST
 ...
 subplot(3,4,1)     
        ...
        hold on
        errorbarplot_joe(Freq_pw,Pwrnan.TPHNEG.(names{n}).(what{2})',[0.5000         0    0.5000],[0.5000         0    0.5000])
        xlim([20 50]); ylim([0 500000]) ;title([char(names(n)), ' RECALL TPH-' ]); 
...
[cw1, t, f]=cwt(LFPsallnan.TPHPOS.(TPHPOS_BNST_L{i}).unFilt.BNST_L.CS{1, 1}(2001:32000),1:.1:150,3,2000);
power1=abs(cw1);
imagesc(t,f,power1,clim); axis xy; title([char(TPHPOS_BNST_L(i)) ' BNST+ CS1 unfil ']); ylim([30 50]);
colorbar

subplot(3,1,2)
[cw10, t, f]=cwt(LFPsallnan.TPHPOS.(TPHPOS_BNST_L{i}).unFilt.BNST_L.CS{1, 10}(2001:32000),1:.1:150,3,2000);
power10=abs(cw10);
imagesc(t,f,power10,clim); axis xy; title([char(TPHPOS_BNST_L(i)) '+ BNST CS10 unfil ']); ylim([30 50]);
colorbar
...
%[cw3, t, f]=cwt(diff,15:.1:150,3,2000);
power10_1=power10-power1;
imagesc(t,f,power10_1,clim); axis xy; title([char(TPHPOS_BNST_L(i)) '+ BNST CS10-CS1 unfil ']); ylim([30 50]);
colorbar
end
...
Freq=Freq_pw;
gamma_freq_idx_30_50=find(Freq>=70 & Freq<=150);
...
%TPH+ ACSF
     subplot(3,4,2)     
        ...
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH- all CSs ', ' ','TPH- pCS3-10'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
        ...
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
         ylim([0 500000]);legend('TPH- CS1-4 ', ' ','TPH- pCS3-10'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
        ...
        bar(4,(mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on; errorbar(4,mean(mean(fooTPHNEG{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')     
        ylim([0 500000]);legend('TPH- CS7-10 ', ' ','TPH- pCS3-10'); 
        title([char(names(n)), ' RECALL Power under curve 30to50Hz '])
...
figure(2)     
     subplot(2,3,1)
       ...
       subplot(2,3,4)
        CS_SEM = std(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5 0')
        hold on 
        errorbar(1,mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
         CS_SEM = std(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{2,1}(gamma_freq_idx_30_50,:)))-1);
         bar(2,(mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
         hold on 
         errorbar(2,mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        ylim([0 1]); 
        title([char(names(n)), ' TPHNEG ' char(what(1))])
        legend('all CSs ', ' ','pCSs')

        subplot(2,3,5)
        CS_SEM = std(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5 0')
        hold on 
        errorbar(1,mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
         CS_SEM = std(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{2,1}(gamma_freq_idx_30_50,:)))-1);
         bar(2,(mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
         hold on 
        ...
        subplot(2,3,6)
        CS_SEM = std(mean(fooctrls{4,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{4,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{4,1}(gamma_freq_idx_30_50,:)))),'FaceColor','1.0000 0.5 0')
        hold on 
        errorbar(1,mean(mean(fooctrls{4,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        CS_SEM = std(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{2,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.5000 0 0.5000')
        hold on 
...
figure(4)     
        ...
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHNEG);
        CS_SEM = std(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on 
        errorbar(1,mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHPOS);
        CS_SEM = std(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{1,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on 
        errorbar(2,mean(mean(fooctrls{1,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        ylim([0 1.2]); 
        ...
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHNEG);
        CS_SEM = std(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{2,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on 
        errorbar(1,mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHPOS);
        CS_SEM = std(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{2,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on 
        errorbar(2,mean(mean(fooctrls{2,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        ylim([0 1.2]); 
        ...
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHNEG);
        CS_SEM = std(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(1,(mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0.8 0.8 0.8')
        hold on 
        errorbar(1,mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        fooctrls=struct2cell(Coh_all.BNSTCeA.TPHPOS);
        CS_SEM = std(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))/sqrt(length(sum(fooctrls{3,1}(gamma_freq_idx_30_50,:)))-1);
        bar(2,(mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:)))),'FaceColor','0 0 1')
        hold on 
        errorbar(2,mean(mean(fooctrls{3,1}(gamma_freq_idx_30_50,:))),mean(CS_SEM), 'k.')
        hold on
        ylim([0 1.2]); 
